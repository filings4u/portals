...
const modules={
 enterprise:{label:'Enterprise',landing:'admin-dashboard.html',product:null,groups:[
  ...
  ['Commerce & Service',[
   ['admin-revenue-service-management.html','Revenue & Service Management','finance'],['admin-catalog-management.html','Storefront & Catalogs','services'],['admin-service-desk.html','Service Desk & Records','help'],['admin-intake-documents.html','Intake Documents','docs']]],
  ['Governance',[
