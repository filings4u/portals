...
const modules={
 enterprise:{label:'Enterprise',landing:'admin-dashboard.html',product:null,groups:[
  ['Enterprise Control Plane',[
   ['admin-organizations.html','Organizations & Accounts','crm'],['admin-people.html','People & Identity','staff'],['admin-access.html','Portal Users & Access','user'],['admin-customer-operations.html','Customer Operations','operations'],['admin-customer-setup.html','Customer Setup & Configuration','operations'],['admin-work-management.html','Work Management','schedule']]],
  ['Operations & Governance',[
   ['admin-operations-command-center.html','Operations Command Center','operations'],['admin-compliance-command-center.html','Compliance Command Center','audit'],['admin-agency-workforce-management.html','Agency & Workforce Management','staff'],['admin-revenue-service-management.html','Revenue & Service Management','finance'],['admin-catalog-management.html','Storefront & Catalogs','services'],['admin-service-desk.html','Service Desk & Records','help'],['admin-security-access.html','Security & Access','audit'],['admin-legacy-routes.html','Portal Routes','tech']]]]},
...
const adminItems=[
 ['admin-organizations.html','Organizations & Accounts','crm'],
 ['admin-customer-setup.html','Customer Setup & Configuration','operations'],
 ['admin-customer-operations.html','Customer Operations','operations'],
 ['admin-operations-command-center.html','Operations Command Center','operations'],
 ['admin-compliance-command-center.html','Compliance Command Center','audit'],
 ['admin-agency-workforce-management.html','Agency & Workforce Management','staff'],
 ['admin-revenue-service-management.html','Revenue & Service Management','finance'],
 ['admin-testing-command-center.html','Testing Command Center','testing'],
 ['admin-work-management.html','Work Management','schedule'],
 ['admin-people.html','People & Workforce','staff'],
 ['admin-access.html','Portal Users & Access','user'],
 ['admin-catalog-management.html','Storefront & Catalogs','services'],
 ['admin-service-desk.html','Service Desk & Records','help'],
 ['admin-security-access.html','Security & Access','audit'],
